"""
GenoCheck — Interactive Web Simulator
Flask backend for the GenoCheck DNA sequence validator.

Provides REST API endpoints for the web UI to call the three validation stages.
"""
...
def validate_sequence():
    ...
    Input: {"sequence": "ATGCGATAA"}
    Output: Complete validation result with all three stages
    """
    ...
    # Stage 2: PDA (only if Stage 1 passed)
    if dfa_result["accepted"]:
        ...
        # Stage 3: TM (only if Stage 2 passed)
